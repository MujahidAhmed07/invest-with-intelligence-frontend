...
function Description() {
  ...
  const entreprenuerMetaData = data.entreprenuerMetaData || {};
  const startup = data || {};
          ...
          <Card.Body>
              ...
              <Card.Body>
                ...
                <Row>
                  ...
                  <Col>
                    ...
                    <p>{startup.startupLocation}</p>

                    <h5>Startup Category</h5>
                    <p>{startup.startupCategory}</p>
                  </Col>

                  <Col>
                    <h5>Startup Date Joined</h5>
                    <p>{startup.dateJoined}</p>
                  </Col>
            ...
            <Card className="mb-6">
              <Card.Body>
                ...
                <Row>
                  <Col>
                    <div style={{ whiteSpace: 'pre-line' }}>{startup.startupDetails}</div>
                  </Col>
            ...
            <Card className="mb-6">
              <Card.Body>
                ...
                <Row className="mb-5">
                  <Col>
                    <h5>Owner Name</h5>
                    <p>{entreprenuerMetaData.fname + ' ' + entreprenuerMetaData.lname}</p>
                    <h5>Contact</h5>
                    <p>{entreprenuerMetaData.contact}</p>
                  </Col>
                  <Col>
                    <h5>City</h5>
                    <p>{entreprenuerMetaData.city}</p>

                    <h5>Address</h5>
                    <p>{entreprenuerMetaData.address}</p>
                  </Col>
                </Row>
                {/* <Row><hr className="mb-4" /></Row> */}
                <Row>
                  <h5>About Entreprenuer</h5>
                  <p>{entreprenuerMetaData.description}</p>
                </Row>
              </Card.Body>
            </Card>
